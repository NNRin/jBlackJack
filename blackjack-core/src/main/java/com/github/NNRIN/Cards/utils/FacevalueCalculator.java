...
public class FacevalueCalculator implements IFacevalueCalculator {
    ...
    public int[] getCardValue(Card card) {
        return switch (card.facevalue()) {
            ...
            case Facevalues.Two -> new int[]{2};
            case Facevalues.Three -> new int[]{3};
            case Facevalues.Four -> new int[]{4};
            case Facevalues.Five -> new int[]{5};
            case Facevalues.Six -> new int[]{6};
            case Facevalues.Seven -> new int[]{7};
            case Facevalues.Eight -> new int[]{8};
            case Facevalues.Nine -> new int[]{9};
            case Facevalues.Ten, Facevalues.Jack, Facevalues.Queen, Facevalues.King -> new int[]{10};
